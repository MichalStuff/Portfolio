...
const Menu = () => {
  ...
  return (
    <nav className=" text-white font-roboto font-normal fixed flex items-center justify-center bottom-0 w-[100svw] h-16 px-6 bg-navy_light max-w-[425px] sm:rounded-xl -translate-x-1/2 left-1/2 md:bottom-3">
